      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-md">
          ...
          >
            ...
            <div className={`p-8 text-center ${!post.imageUrl ? "pt-12" : "pt-0 -mt-6 relative"}`}>
              {/* Optional "Special Offer" Ribbon / Badge */}
              <div className="mb-4 inline-block rounded-full bg-orange-500/20 px-3 py-1 text-xs font-semibold tracking-wider text-orange-400 border border-orange-500/30">
                SPECIAL OFFER
              </div>
              ...
              {post.description && (
                <p className="mb-8 text-base leading-relaxed text-[#a3c4b1]">
                  {post.description}
                </p>
              )}
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  ...
                  className="flex w-full items-center justify-center rounded-xl bg-[#25D366] px-6 py-4 text-base font-bold text-white shadow-lg transition-all hover:bg-[#20bd5a] hover:shadow-xl hover:scale-[1.02] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#1a3024]"
                >
                ...
                <button
                  onClick={handleLater}
                  className="mt-2 text-sm font-medium text-[#a3c4b1] transition-colors hover:text-white underline decoration-transparent hover:decoration-white/50 underline-offset-4 focus:outline-none"
                >
                  Remind me later
                </button>
              </div>

...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Chaam Safari & Tours', description: 'Read the wild closely.', url: '/', siteName: 'Chaam Safari & Tours', type: 'website', images: ['/safari-hero.png'] },
  twitter: { card: 'summary_large_image', title: 'Chaam Safari & Tours', description: 'Private safari experiences in Sri Lanka.', images: ['/safari-hero.png'] },
}
